...
|  时间   | 分数  | 具体操作 |
|  ----  | ----  | --------  |
| 2022/5/25  | 0.621672 |   将title和ocr,asr的前64个字符和后64个字符拼接起来，采用roberta-base, seqlen=256, 两个lr都4e-5, bastch_size为32，线下0.6332  |
|  2022/5/26 | 0.629065 | 加入ema, fgm，ema的decay为0.995， 学习率调大，调成5e-5, 其余不变， 线下0.6526，线上线下grap变大|
