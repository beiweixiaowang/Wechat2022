...
class XLMConfig(PretrainedConfig):
    """
        ...
        It is used to instantiate an XLM nezha_model according to the specified arguments, defining the nezha_model
        ...
        to control the nezha_model outputs. Read the documentation from  :class:`~transformers1.PretrainedConfig`
        for more information.

        Args:
            vocab_size (:obj:`int`, optional, defaults to 30145):
                Vocabulary size of the XLM nezha_model. Defines the different tokens that
            ...
            causal (:obj:`boolean`, optional, defaults to :obj:`False`):
                Set this to `True` for the nezha_model to behave in a causal manner.
            ...
            n_langs (:obj:`int`, optional, defaults to 1):
                The number of languages the nezha_model handles. Set to 1 for monolingual models.
            ...
            max_position_embeddings (:obj:`int`, optional, defaults to 512):
                The maximum sequence length that this nezha_model might
            ...
            is_encoder(:obj:`boolean`, optional, defaults to :obj:`True`):
                Whether the initialized nezha_model should be a transformer encoder or decoder as seen in Vaswani et al.
            ...
            lang_id (:obj:`int`, optional, defaults to 1):
                The ID of the language used by the nezha_model. This parameter is used when generating
        ...
        Example::
            ...
            nezha_model = XLMModel(configuration)
