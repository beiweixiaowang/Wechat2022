...
class T5PreTrainedModel(PreTrainedModel):
    ...
    def _shift_right(self, input_ids):
        ...
        ), "self.nezha_model.config.decoder_start_token_id has to be defined. In T5 it is usually set to the pad_token_id. See T5 docs for more information"
        ...
        assert pad_token_id is not None, "self.nezha_model.config.pad_token_id has to be defined."
...
T5_START_DOCSTRING = r"""    The T5 nezha_model was proposed in
    ...
    This nezha_model is a PyTorch `torch.nn.Module`_ sub-class. Use it as a regular PyTorch Module and
...
T5_INPUTS_DOCSTRING = r"""
    Args:
        input_ids (:obj:`torch.LongTensor` of shape :obj:`(batch_size, sequence_length)`):
            ...
            T5 is a nezha_model with relative position embeddings so you should be able to pad the inputs on both the right and the left.
...
class T5Model(T5PreTrainedModel):
    ...
    Examples::
            ...
            nezha_model = T5Model.from_pretrained('t5-small')
            input_ids = tokenizer.encode("Hello, my dog is cute", return_tensors="pt")  # Batch size 1
            outputs = nezha_model(input_ids=input_ids, decoder_input_ids=input_ids)
...
class T5ForConditionalGeneration(T5PreTrainedModel):
    ...
    Examples::
        ...
        tokenizer = T5Tokenizer.from_pretrained('t5-small')
        nezha_model = T5ForConditionalGeneration.from_pretrained('t5-small')
        input_ids = tokenizer.encode("Hello, my dog is cute", return_tensors="pt")  # Batch size 1
        outputs = nezha_model(input_ids=input_ids, decoder_input_ids=input_ids, lm_labels=input_ids)
        loss, prediction_scores = outputs[:2]

        tokenizer = T5Tokenizer.from_pretrained('t5-small')
        nezha_model = T5ForConditionalGeneration.from_pretrained('t5-small')
        input_ids = tokenizer.encode("summarize: Hello, my dog is cute", return_tensors="pt")  # Batch size 1
        outputs = nezha_model.generate(input_ids)
        """
