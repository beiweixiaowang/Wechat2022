...
class TFTrainer:
    ...
    def _setup_training(self) -> None:
        """
        Setup the different steps to train a nezha_model:
          - check if all the data are given
          - create the proper strategy
          - create the features
          - prepare the nezha_model settings
        """
    ...
    def train(self) -> None:
        """
        Train method to train the nezha_model.
        """
        if self.args.debug:
    ...
    def _run_model(self, features, labels, training):
        ...
        Args:
          ...
          training: run the nezha_model in training mode or not
        """
    ...
    def save_model(self) -> None:
        """
        Save the pretrained nezha_model and create a Tensorflow saved nezha_model.
        """
        logger.info("Saving nezha_model in {}".format(self.args.output_dir))

        path = os.path.join(self.args.output_dir, "saved_model")

        logger.info("Saving nezha_model in {}".format(path))
