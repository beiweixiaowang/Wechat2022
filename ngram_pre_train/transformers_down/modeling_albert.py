...
def load_tf_weights_in_albert(model, config, tf_checkpoint_path):
    ...
    for name, array in zip(names, arrays):
        ...
        # No ALBERT nezha_model currently handles the next sentence prediction task
...
ALBERT_START_DOCSTRING = r"""
    ...
    Args:
        config (:class:`~transformers1.AlbertConfig`): Model configuration class with all the parameters of the nezha_model.
...
class AlbertModel(AlbertPreTrainedModel):
    ...
    def _prune_heads(self, heads_to_prune):
        """ Prunes heads of the nezha_model.
            ...
            If an ALBERT nezha_model has 12 hidden layers and 2 hidden groups, with two inner groups, there
    ...
    Example::
        ...
        nezha_model = AlbertModel.from_pretrained('albert-base-v2')
...
class AlbertForPreTraining(AlbertPreTrainedModel):
    ...
    Examples::
        ...
        tokenizer = AlbertTokenizer.from_pretrained('albert-base-v2')
        nezha_model = AlbertForPreTraining.from_pretrained('albert-base-v2')
...
class AlbertForMaskedLM(AlbertPreTrainedModel):
    ...
    Example::
        ...
        tokenizer = AlbertTokenizer.from_pretrained('albert-base-v2')
        nezha_model = AlbertForMaskedLM.from_pretrained('albert-base-v2')
        input_ids = torch.tensor(tokenizer.encode("Hello, my dog is cute", add_special_tokens=True)).unsqueeze(0)  # Batch size 1
...
class AlbertForSequenceClassification(AlbertPreTrainedModel):
    ...
    Returns:
        ...
        Examples::
            ...
            tokenizer = AlbertTokenizer.from_pretrained('albert-base-v2')
            nezha_model = AlbertForSequenceClassification.from_pretrained('albert-base-v2')
...
class AlbertForTokenClassification(AlbertPreTrainedModel):
    ...
    Examples::
        ...
        tokenizer = AlbertTokenizer.from_pretrained('albert-base-v2')
        nezha_model = AlbertForTokenClassification.from_pretrained('albert-base-v2')
...
class AlbertForQuestionAnswering(AlbertPreTrainedModel):
    ...
    Examples::
        ...
        # examples/question-answering/run_squad.py example to see how to fine-tune a nezha_model to a question answering task.

        from transformers1 import AlbertTokenizer, AlbertForQuestionAnswering
        import torch

        tokenizer = AlbertTokenizer.from_pretrained('albert-base-v2')
        nezha_model = AlbertForQuestionAnswering.from_pretrained('albert-base-v2')
        question, text = "Who was Jim Henson?", "Jim Henson was a nice puppet"
        input_dict = tokenizer.encode_plus(question, text, return_tensors='pt')
        start_scores, end_scores = nezha_model(**input_dict)
