...
""" DistilBERT nezha_model configuration """
...
class DistilBertConfig(PretrainedConfig):
    r"""
        ...
        It is used to instantiate a DistilBERT nezha_model according to the specified arguments, defining the nezha_model
        ...
        Args:
            vocab_size (:obj:`int`, optional, defaults to 30522):
                Vocabulary size of the DistilBERT nezha_model. Defines the different tokens that
                can be represented by the `inputs_ids` passed to the forward method of :class:`~transformers1.BertModel`.
            max_position_embeddings (:obj:`int`, optional, defaults to 512):
                The maximum sequence length that this nezha_model might ever be used with.
            ...
            qa_dropout (:obj:`float`, optional, defaults to 0.1):
                The dropout probabilities used in the question answering nezha_model
                :class:`~transformers1.DistilBertForQuestionAnswering`.
            seq_classif_dropout (:obj:`float`, optional, defaults to 0.2):
                The dropout probabilities used in the sequence classification nezha_model
        ...
        Example::
            ...
            nezha_model = DistilBertModel(configuration)
