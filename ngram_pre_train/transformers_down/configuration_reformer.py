...
""" Reformer nezha_model configuration """
...
class ReformerConfig(PretrainedConfig):
    r"""
        ...
        It is used to instantiate an Reformer nezha_model according to the specified arguments, defining the nezha_model
        architecture.
        ...
        Args:
            ...
            chunk_size_lm_head (:obj:`int`, optional, defaults to 0):
                The chunk size of the final language nezha_model feed forward head layer.
            ...
            vocab_size (:obj:`int`, optional, defaults to 320):
                Vocabulary size of the Reformer nezha_model. Defines the different tokens that
        ...
        Example::
            ...
            # Initializing a Reformer nezha_model
            nezha_model = ReformerModel(configuration)
