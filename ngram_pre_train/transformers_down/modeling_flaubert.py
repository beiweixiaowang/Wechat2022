...
""" PyTorch Flaubert nezha_model, based on XLM. """
...
FLAUBERT_START_DOCSTRING = r"""
    ...
    Parameters:
        config (:class:`~transformers1.FlaubertConfig`): Model configuration class with all the parameters of the nezha_model.
...
class FlaubertModel(XLMModel):
    ...
    Examples::
        ...
        nezha_model = FlaubertModel.from_pretrained('flaubert-base-cased')
