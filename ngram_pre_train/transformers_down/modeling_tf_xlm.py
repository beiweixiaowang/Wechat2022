...
class TFXLMModel(TFXLMPreTrainedModel):
    ...
    Examples::
        ...
        nezha_model = TFXLMModel.from_pretrained('xlm-mlm-en-2048')
...
class TFXLMWithLMHeadModel(TFXLMPreTrainedModel):
    ...
    Examples::
        ...
        tokenizer = XLMTokenizer.from_pretrained('xlm-mlm-en-2048')
        nezha_model = TFXLMWithLMHeadModel.from_pretrained('xlm-mlm-en-2048')
        input_ids = tf.constant(tokenizer.encode("Hello, my dog is cute", add_special_tokens=True))[None, :]  # Batch size 1
        outputs = nezha_model(input_ids)
        last_hidden_states = outputs[0]  # The last hidden-state is the first element of the output tuple
...
class TFXLMForSequenceClassification(TFXLMPreTrainedModel):
    ...
    Examples::
        ...
        tokenizer = XLMTokenizer.from_pretrained('xlm-mlm-en-2048')
        nezha_model = TFXLMForSequenceClassification.from_pretrained('xlm-mlm-en-2048')
        input_ids = tf.constant(tokenizer.encode("Hello, my dog is cute", add_special_tokens=True))[None, :]  # Batch size 1
...
class TFXLMForQuestionAnsweringSimple(TFXLMPreTrainedModel):
    ...
    Examples::
        ...
        tokenizer = XLMTokenizer.from_pretrained('xlm-mlm-en-2048')
        nezha_model = TFXLMForQuestionAnsweringSimple.from_pretrained('xlm-mlm-en-2048')
        input_ids = tf.constant(tokenizer.encode("Hello, my dog is cute", add_special_tokens=True))[None, :]  # Batch size 1
        outputs = nezha_model(input_ids)
