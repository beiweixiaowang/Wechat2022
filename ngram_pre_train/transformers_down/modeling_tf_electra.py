...
ELECTRA_START_DOCSTRING = r"""
    This nezha_model is a `tf.keras.Model <https://www.tensorflow.org/api_docs/python/tf/keras/Model>`__ sub-class.
...
class TFElectraModel(TFElectraPreTrainedModel):
    ...
    Examples::
        ...
        nezha_model = TFElectraModel.from_pretrained('google/electra-small-discriminator')
...
Even though both the discriminator and generator may be loaded into this nezha_model, the discriminator is
the only nezha_model of the two to have the correct classification head to be used for this nezha_model.""",
    ELECTRA_START_DOCSTRING,
)
class TFElectraForPreTraining(TFElectraPreTrainedModel):
    ...
    Examples::
        ...
        tokenizer = ElectraTokenizer.from_pretrained('google/electra-small-discriminator')
        nezha_model = TFElectraForPreTraining.from_pretrained('google/electra-small-discriminator')
        input_ids = tf.constant(tokenizer.encode("Hello, my dog is cute"))[None, :]  # Batch size 1
        outputs = nezha_model(input_ids)
        scores = outputs[0]
        """
...
class TFElectraForMaskedLM(TFElectraPreTrainedModel):
    ...
    Examples::
        ...
        nezha_model = TFElectraForMaskedLM.from_pretrained('google/electra-small-generator')
        input_ids = tf.constant(tokenizer.encode("Hello, my dog is cute"))[None, :]  # Batch size 1
        outputs = nezha_model(input_ids)
...
class TFElectraForTokenClassification(TFElectraPreTrainedModel):
    ...
    Examples::
        ...
        tokenizer = ElectraTokenizer.from_pretrained('google/electra-small-discriminator')
        nezha_model = TFElectraForTokenClassification.from_pretrained('google/electra-small-discriminator')
        input_ids = tf.constant(tokenizer.encode("Hello, my dog is cute"))[None, :]  # Batch size 1
        outputs = nezha_model(input_ids)
        scores = outputs[0]
        """
