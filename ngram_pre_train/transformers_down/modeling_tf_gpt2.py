...
""" TF 2.0 OpenAI GPT-2 nezha_model. """
...
GPT2_INPUTS_DOCSTRING = r"""
    Args:
        ...
        past (:obj:`List[tf.Tensor]` of length :obj:`config.n_layers`):
            ...
            The token ids which have their past given to this nezha_model
...
class TFGPT2Model(TFGPT2PreTrainedModel):
    ...
    Examples::
        ...
        nezha_model = TFGPT2Model.from_pretrained('gpt2')
...
class TFGPT2LMHeadModel(TFGPT2PreTrainedModel):
    ...
    Examples::
        ...
        tokenizer = GPT2Tokenizer.from_pretrained('gpt2')
        nezha_model = TFGPT2LMHeadModel.from_pretrained('gpt2')
...
class TFGPT2DoubleHeadsModel(TFGPT2PreTrainedModel):
    ...
    Examples::
        ...
        tokenizer = GPT2Tokenizer.from_pretrained('gpt2')
        nezha_model = TFGPT2DoubleHeadsModel.from_pretrained('gpt2')
