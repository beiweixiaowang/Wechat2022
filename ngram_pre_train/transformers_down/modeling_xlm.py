...
XLM_START_DOCSTRING = r"""
    ...
    Parameters:
        config (:class:`~transformers1.XLMConfig`): Model configuration class with all the parameters of the nezha_model.
...
XLM_INPUTS_DOCSTRING = r"""
    Args:
        ...
        langs (:obj:`torch.LongTensor` of shape :obj:`(batch_size, sequence_length)`, `optional`, defaults to :obj:`None`):
            ...
            provided in the configuration of the nezha_model (only provided for multilingual models).
            More precisely, the `language name -> language id` mapping is in `nezha_model.config.lang2id` (dict str -> int) and
            the `language id -> language name` mapping is `nezha_model.config.id2lang` (dict int -> str).
        ...
        cache (:obj:`Dict[str, torch.FloatTensor]`, `optional`, defaults to :obj:`None`):
            ...
            hidden-states (key and values in the attention blocks) as computed by the nezha_model
...
class XLMModel(XLMPreTrainedModel):
    ...
    Examples::
        ...
        nezha_model = XLMModel.from_pretrained('xlm-mlm-en-2048')
...
class XLMWithLMHeadModel(XLMPreTrainedModel):
    ...
    Examples::
        ...
        tokenizer = XLMTokenizer.from_pretrained('xlm-mlm-en-2048')
        nezha_model = XLMWithLMHeadModel.from_pretrained('xlm-mlm-en-2048')
        input_ids = torch.tensor(tokenizer.encode("Hello, my dog is cute", add_special_tokens=True)).unsqueeze(0)  # Batch size 1
        outputs = nezha_model(input_ids)
        last_hidden_states = outputs[0]  # The last hidden-state is the first element of the output tuple
...
class XLMForSequenceClassification(XLMPreTrainedModel):
    ...
    Examples::
        ...
        tokenizer = XLMTokenizer.from_pretrained('xlm-mlm-en-2048')
        nezha_model = XLMForSequenceClassification.from_pretrained('xlm-mlm-en-2048')
        input_ids = torch.tensor(tokenizer.encode("Hello, my dog is cute", add_special_tokens=True)).unsqueeze(0)  # Batch size 1
...
class XLMForQuestionAnsweringSimple(XLMPreTrainedModel):
    ...
    Examples::
        ...
        tokenizer = XLMTokenizer.from_pretrained('xlm-mlm-en-2048')
        nezha_model = XLMForQuestionAnsweringSimple.from_pretrained('xlm-mlm-en-2048')
        input_ids = torch.tensor(tokenizer.encode("Hello, my dog is cute", add_special_tokens=True)).unsqueeze(0)  # Batch size 1
...
class XLMForQuestionAnswering(XLMPreTrainedModel):
    ...
    Examples::
        ...
        tokenizer = XLMTokenizer.from_pretrained('xlm-mlm-en-2048')
        nezha_model = XLMForQuestionAnswering.from_pretrained('xlm-mlm-en-2048')
        input_ids = torch.tensor(tokenizer.encode("Hello, my dog is cute", add_special_tokens=True)).unsqueeze(0)  # Batch size 1
        start_positions = torch.tensor([1])
        end_positions = torch.tensor([3])
        outputs = nezha_model(input_ids, start_positions=start_positions, end_positions=end_positions)
...
class XLMForTokenClassification(XLMPreTrainedModel):
    ...
    Examples::
        ...
        nezha_model = XLMForTokenClassification.from_pretrained('xlm-mlm-100-1280')
