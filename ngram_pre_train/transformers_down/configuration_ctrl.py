...
class CTRLConfig(PretrainedConfig):
    """
        ...
        It is used to instantiate an CTRL nezha_model according to the specified arguments, defining the nezha_model
        ...
        Args:
            vocab_size (:obj:`int`, optional, defaults to 246534):
                Vocabulary size of the CTRL nezha_model. Defines the different tokens that
        ...
        Example::
            ...
            nezha_model = CTRLModel(configuration)
