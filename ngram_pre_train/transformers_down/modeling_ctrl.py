...
CTRL_START_DOCSTRING = r"""
    ...
    Parameters:
        config (:class:`~transformers1.CTRLConfig`): Model configuration class with all the parameters of the nezha_model.
...
CTRL_INPUTS_DOCSTRING = r"""
    Args:
        ...
        past (:obj:`List[torch.FloatTensor]` of length :obj:`config.n_layers`):
            ...
            The input_ids which have their past given to this nezha_model should not be passed as input ids as they have already been computed.
...
class CTRLModel(CTRLPreTrainedModel):
    ...
    Examples::
        ...
        nezha_model = CTRLModel.from_pretrained('ctrl')
...
class CTRLLMHeadModel(CTRLPreTrainedModel):
    ...
    Examples::
        ...
        tokenizer = CTRLTokenizer.from_pretrained('ctrl')
        nezha_model = CTRLLMHeadModel.from_pretrained('ctrl')
