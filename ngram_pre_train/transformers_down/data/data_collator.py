...
class DefaultDataCollator(DataCollator):
    ...
    i.e., Property names of the input object will be used as corresponding inputs to the nezha_model.
    ...
    def collate_batch(self, features: List[InputDataClass]) -> Dict[str, torch.Tensor]:
        ...
        # Again, we will use the first element to figure out which key/values are not None for this nezha_model.
