...
class InputFeatures:
    ...
    Property names are the same names as the corresponding inputs to a nezha_model.
...
class SingleSentenceClassificationProcessor(DataProcessor):
    ...
    def get_features(
        ...
        Returns:
            ...
            a list of task-specific ``InputFeatures`` which can be fed to the nezha_model.
