...
class TransfoXLConfig(PretrainedConfig):
    """
        ...
        It is used to instantiate a Transformer XL nezha_model according to the specified arguments, defining the nezha_model
        ...
        Args:
            vocab_size (:obj:`int`, optional, defaults to 267735):
                Vocabulary size of the Transformer XL nezha_model. Defines the different tokens that
        ...
        Example::
            ...
            nezha_model = TransfoXLModel(configuration)
