...
""" BERT nezha_model configuration """
...
class BertConfig(PretrainedConfig):
    r"""
        ...
        It is used to instantiate an BERT nezha_model according to the specified arguments, defining the nezha_model
        ...
        Args:
            vocab_size (:obj:`int`, optional, defaults to 30522):
                Vocabulary size of the BERT nezha_model. Defines the different tokens that
        ...
        Example::
            ...
            # Initializing a nezha_model from the bert-base-uncased style configuration
            nezha_model = BertModel(configuration)
