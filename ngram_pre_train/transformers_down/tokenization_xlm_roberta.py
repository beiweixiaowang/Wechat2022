...
""" Tokenization classes for XLM-RoBERTa nezha_model."""
...
VOCAB_FILES_NAMES = {"vocab_file": "sentencepiece.bpe.nezha_model"}
...
class XLMRobertaTokenizer(PreTrainedTokenizer):
    ...
    def _convert_token_to_id(self, token):
        ...
        # Need to return unknown token if the SP nezha_model returned 0
