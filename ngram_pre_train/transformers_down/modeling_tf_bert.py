...
class TFBertModel(TFBertPreTrainedModel):
    ...
    Examples::
        ...
        nezha_model = TFBertModel.from_pretrained('bert-base-uncased')
...
class TFBertForPreTraining(TFBertPreTrainedModel):
    ...
    Examples::
        ...
        tokenizer = BertTokenizer.from_pretrained('bert-base-uncased')
        nezha_model = TFBertForPreTraining.from_pretrained('bert-base-uncased')
        input_ids = tf.constant(tokenizer.encode("Hello, my dog is cute", add_special_tokens=True))[None, :]  # Batch size 1
        outputs = nezha_model(input_ids)
...
class TFBertForMaskedLM(TFBertPreTrainedModel):
    ...
    Examples::
        ...
        tokenizer = BertTokenizer.from_pretrained('bert-base-uncased')
        nezha_model = TFBertForMaskedLM.from_pretrained('bert-base-uncased')
        input_ids = tf.constant(tokenizer.encode("Hello, my dog is cute", add_special_tokens=True))[None, :]  # Batch size 1
        outputs = nezha_model(input_ids)
...
class TFBertForNextSentencePrediction(TFBertPreTrainedModel):
    ...
    Examples::
        ...
        tokenizer = BertTokenizer.from_pretrained('bert-base-uncased')
        nezha_model = TFBertForNextSentencePrediction.from_pretrained('bert-base-uncased')

        prompt = "In Italy, pizza served in formal settings, such as at a restaurant, is presented unsliced."
        next_sentence = "The sky is blue due to the shorter wavelength of blue light."
        encoding = tokenizer.encode_plus(prompt, next_sentence, return_tensors='tf')

        logits = nezha_model(encoding['input_ids'], token_type_ids=encoding['token_type_ids'])[0]
...
class TFBertForSequenceClassification(TFBertPreTrainedModel):
    ...
    Examples::
        ...
        tokenizer = BertTokenizer.from_pretrained('bert-base-uncased')
        nezha_model = TFBertForSequenceClassification.from_pretrained('bert-base-uncased')
        input_ids = tf.constant(tokenizer.encode("Hello, my dog is cute", add_special_tokens=True))[None, :]  # Batch size 1
        outputs = nezha_model(input_ids)
        logits = outputs[0]
...
class TFBertForMultipleChoice(TFBertPreTrainedModel):
    ...
    Examples::
        ...
        tokenizer = BertTokenizer.from_pretrained('bert-base-uncased')
        nezha_model = TFBertForMultipleChoice.from_pretrained('bert-base-uncased')
        ...
        outputs = nezha_model(encoding['input_ids'][None, :])
        logits = outputs[0]
        """
        if isinstance(inputs, (tuple, list)):
            input_ids = inputs[0]
...
class TFBertForTokenClassification(TFBertPreTrainedModel):
    ...
    Examples::
        ...
        tokenizer = BertTokenizer.from_pretrained('bert-base-uncased')
        nezha_model = TFBertForTokenClassification.from_pretrained('bert-base-uncased')
        input_ids = tf.constant(tokenizer.encode("Hello, my dog is cute", add_special_tokens=True))[None, :]  # Batch size 1
        outputs = nezha_model(input_ids)
        scores = outputs[0]
...
class TFBertForQuestionAnswering(TFBertPreTrainedModel):
    ...
    Examples::
        ...
        tokenizer = BertTokenizer.from_pretrained('bert-base-uncased')
        nezha_model = TFBertForQuestionAnswering.from_pretrained('bert-large-uncased-whole-word-masking-finetuned-squad')

        question, text = "Who was Jim Henson?", "Jim Henson was a nice puppet"
        encoding = tokenizer.encode_plus(question, text)
        input_ids, token_type_ids = encoding["input_ids"], encoding["token_type_ids"]
        start_scores, end_scores = nezha_model(tf.constant(input_ids)[None, :], token_type_ids=tf.constant(token_type_ids)[None, :])
