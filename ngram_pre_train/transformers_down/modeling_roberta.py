...
class RobertaForMaskedLM(BertPreTrainedModel):
    ...
    Examples::
        ...
        nezha_model = RobertaForMaskedLM.from_pretrained('roberta-base')
...
class RobertaForSequenceClassification(BertPreTrainedModel):
    ...
    Examples::
        ...
        tokenizer = RobertaTokenizer.from_pretrained('roberta-base')
        nezha_model = RobertaForSequenceClassification.from_pretrained('roberta-base')
        input_ids = torch.tensor(tokenizer.encode("Hello, my dog is cute", add_special_tokens=True)).unsqueeze(0)  # Batch size 1
...
class RobertaForMultipleChoice(BertPreTrainedModel):
    ...
    Examples::
        ...
        tokenizer = RobertaTokenizer.from_pretrained('roberta-base')
        nezha_model = RobertaForMultipleChoice.from_pretrained('roberta-base')
...
class RobertaForTokenClassification(BertPreTrainedModel):
    ...
    Examples::
        ...
        tokenizer = RobertaTokenizer.from_pretrained('roberta-base')
        nezha_model = RobertaForTokenClassification.from_pretrained('roberta-base')
        input_ids = torch.tensor(tokenizer.encode("Hello, my dog is cute", add_special_tokens=True)).unsqueeze(0)  # Batch size 1
...
class RobertaForQuestionAnswering(BertPreTrainedModel):
    ...
    Examples::
        ...
        tokenizer = RobertaTokenizer.from_pretrained('roberta-base')
        nezha_model = RobertaForQuestionAnswering.from_pretrained('roberta-base')

        question, text = "Who was Jim Henson?", "Jim Henson was a nice puppet"
        input_ids = tokenizer.encode(question, text)
        start_scores, end_scores = nezha_model(torch.tensor([input_ids]))
