...
class OpenAIGPTConfig(PretrainedConfig):
    """
        ...
        It is used to instantiate an GPT nezha_model according to the specified arguments, defining the nezha_model
        ...
        Args:
            vocab_size (:obj:`int`, optional, defaults to 40478):
                Vocabulary size of the GPT nezha_model. Defines the different tokens that
            ...
            predict_special_tokens (:obj:`boolean`, optional, defaults to :obj:`True`):
                Whether special tokens should be predicted when the nezha_model is has a language modeling head.
        ...
        Example::
            ...
            nezha_model = OpenAIGPTModel(configuration)
