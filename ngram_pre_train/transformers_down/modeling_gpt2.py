...
"""PyTorch OpenAI GPT-2 nezha_model."""
...
GPT2_START_DOCSTRING = r"""
    ...
    Parameters:
        config (:class:`~transformers1.GPT2Config`): Model configuration class with all the parameters of the nezha_model.
...
GPT2_INPUTS_DOCSTRING = r"""
    Args:
        ...
        past (:obj:`List[torch.FloatTensor]` of length :obj:`config.n_layers`):
            ...
            The `input_ids` which have their past given to this nezha_model should not be passed as `input_ids` as they have already been computed.
...
class GPT2LMHeadModel(GPT2PreTrainedModel):
    ...
    Examples::
        ...
        tokenizer = GPT2Tokenizer.from_pretrained('gpt2')
        nezha_model = GPT2LMHeadModel.from_pretrained('gpt2')

        input_ids = torch.tensor(tokenizer.encode("Hello, my dog is cute", add_special_tokens=True)).unsqueeze(0)  # Batch size 1
        outputs = nezha_model(input_ids, labels=input_ids)
...
class GPT2DoubleHeadsModel(GPT2PreTrainedModel):
    ...
    def forward(
        ...
        lm_labels (:obj:`torch.LongTensor` of shape :obj:`(batch_size, sequence_length)`, `optional`, defaults to :obj:`None`)
            Labels for language modeling.
            Note that the labels **are shifted** inside the nezha_model, i.e. you can set ``lm_labels = input_ids``
    ...
    Examples::
        ...
        tokenizer = GPT2Tokenizer.from_pretrained('gpt2')
        nezha_model = GPT2DoubleHeadsModel.from_pretrained('gpt2')

        # Add a [CLS] to the vocabulary (we should train it also!)
        tokenizer.add_special_tokens({'cls_token': '[CLS]'})
        nezha_model.resize_token_embeddings(len(tokenizer))  # Update the nezha_model embeddings with the new vocabulary size
        ...
        outputs = nezha_model(input_ids, mc_token_ids=mc_token_ids)
