...
class TFDistilBertModel(TFDistilBertPreTrainedModel):
    ...
    Examples::
        ...
        nezha_model = TFDistilBertModel.from_pretrained('distilbert-base-cased')
...
class TFDistilBertForMaskedLM(TFDistilBertPreTrainedModel):
    ...
    Examples::
        ...
        tokenizer = DistilBertTokenizer.from_pretrained('distilbert-base-cased')
        nezha_model = TFDistilBertForMaskedLM.from_pretrained('distilbert-base-cased')
        input_ids = tf.constant(tokenizer.encode("Hello, my dog is cute"))[None, :]  # Batch size 1
        outputs = nezha_model(input_ids)
...
class TFDistilBertForSequenceClassification(TFDistilBertPreTrainedModel):
    ...
    Examples::
        ...
        tokenizer = DistilBertTokenizer.from_pretrained('distilbert-base-cased')
        nezha_model = TFDistilBertForSequenceClassification.from_pretrained('distilbert-base-cased')
        input_ids = tf.constant(tokenizer.encode("Hello, my dog is cute"))[None, :]  # Batch size 1
        outputs = nezha_model(input_ids)
        logits = outputs[0]
...
class TFDistilBertForTokenClassification(TFDistilBertPreTrainedModel):
    ...
    Examples::
        ...
        tokenizer = DistilBertTokenizer.from_pretrained('distilbert-base-cased')
        nezha_model = TFDistilBertForTokenClassification.from_pretrained('distilbert-base-cased')
        input_ids = tf.constant(tokenizer.encode("Hello, my dog is cute"))[None, :]  # Batch size 1
        outputs = nezha_model(input_ids)
        scores = outputs[0]
        """
...
class TFDistilBertForQuestionAnswering(TFDistilBertPreTrainedModel):
    ...
    Examples::
        ...
        tokenizer = DistilBertTokenizer.from_pretrained('distilbert-base-cased')
        nezha_model = TFDistilBertForQuestionAnswering.from_pretrained('distilbert-base-cased')
        input_ids = tf.constant(tokenizer.encode("Hello, my dog is cute"))[None, :]  # Batch size 1
        outputs = nezha_model(input_ids)
