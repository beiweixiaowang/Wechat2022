...
""" ALBERT nezha_model configuration """
...
class AlbertConfig(PretrainedConfig):
    r"""
        ...
        It is used to instantiate an ALBERT nezha_model according to the specified arguments, defining the nezha_model
        ...
        Args:
            vocab_size (:obj:`int`, optional, defaults to 30000):
                Vocabulary size of the ALBERT nezha_model. Defines the different tokens that
            ...
            max_position_embeddings (:obj:`int`, optional, defaults to 512):
                The maximum sequence length that this nezha_model might ever be used with. Typically set this to something
        ...
        Example::
            ...
            # Initializing a nezha_model from the ALBERT-base style configuration
            nezha_model = AlbertModel(albert_xxlarge_configuration)
