...
class XLNetConfig(PretrainedConfig):
    """
        ...
        It is used to instantiate an XLNet nezha_model according to the specified arguments, defining the nezha_model
        ...
        Args:
            vocab_size (:obj:`int`, optional, defaults to 32000):
                Vocabulary size of the XLNet nezha_model. Defines the different tokens that
            ...
            attn_type (:obj:`string`, optional, defaults to "bi"):
                The attention type used by the nezha_model. Set 'bi' for XLNet, 'uni' for Transformer-XL.
        ...
        Example::
            ...
            nezha_model = XLNetModel(configuration)
