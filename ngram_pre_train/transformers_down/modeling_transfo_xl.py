...
""" PyTorch Transformer XL nezha_model.
...
def build_tf_to_pytorch_map(model, config):
    """ A map of modules from TF to PyTorch.
        This time I use a map to keep the PyTorch nezha_model as identical to the original PyTorch nezha_model as possible.
    """
    tf_to_pt_map = {}
...
TRANSFO_XL_START_DOCSTRING = r"""
    ...
    Parameters:
        config (:class:`~transformers1.TransfoXLConfig`): Model configuration class with all the parameters of the nezha_model.
...
class TransfoXLModel(TransfoXLPreTrainedModel):
    ...
    def _prune_heads(self, heads):
        logger.info("Head pruning is not implemented for Transformer-XL nezha_model")
        pass
    ...
    Examples::
        ...
        nezha_model = TransfoXLModel.from_pretrained('transfo-xl-wt103')
...
class TransfoXLLMHeadModel(TransfoXLPreTrainedModel):
    ...
    def forward(self, input_ids=None, mems=None, head_mask=None, inputs_embeds=None, labels=None):
        ...
        labels (:obj:`torch.LongTensor` of shape :obj:`(batch_size, sequence_length)`, `optional`, defaults to :obj:`None`):
            ...
            Note that the labels **are shifted** inside the nezha_model, i.e. you can set ``labels = input_ids``
    ...
    Examples::
        ...
        tokenizer = TransfoXLTokenizer.from_pretrained('transfo-xl-wt103')
        nezha_model = TransfoXLLMHeadModel.from_pretrained('transfo-xl-wt103')
        input_ids = torch.tensor(tokenizer.encode("Hello, my dog is cute", add_special_tokens=True)).unsqueeze(0)  # Batch size 1
        outputs = nezha_model(input_ids)
