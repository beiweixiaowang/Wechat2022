...
"""PyTorch Longformer nezha_model. """
...
LONGFORMER_INPUTS_DOCSTRING = r"""
    Args:
        ...
        global_attention_mask (:obj:`torch.FloatTensor` of shape :obj:`{0}`, `optional`, defaults to :obj:`None`):
            ...
            task-specific finetuning because it makes the nezha_model more flexible at representing the task. For example,
...
class LongformerModel(RobertaModel):
    ...
    Examples::
        ...
        nezha_model = LongformerModel.from_pretrained('allenai/longformer-base-4096')
        ...
        sequence_output, pooled_output = nezha_model(input_ids, attention_mask=attention_mask)
        """
...
class LongformerForMaskedLM(BertPreTrainedModel):
    ...
    Examples::
        ...
        nezha_model = LongformerForMaskedLM.from_pretrained('allenai/longformer-base-4096')
        tokenizer = LongformerTokenizer.from_pretrained('allenai/longformer-base-4096')
        ...
        loss, prediction_scores = nezha_model(input_ids, attention_mask=attention_mask, masked_lm_labels=input_ids)
        """
...
class LongformerForSequenceClassification(BertPreTrainedModel):
    ...
    Examples::
        ...
        tokenizer = LongformerTokenizer.from_pretrained('allenai/longformer-base-4096')
        nezha_model = LongformerForSequenceClassification.from_pretrained('allenai/longformer-base-4096')
...
class LongformerForQuestionAnswering(BertPreTrainedModel):
    ...
    Examples::
        ...
        nezha_model = LongformerForQuestionAnswering.from_pretrained("allenai/longformer-large-4096-finetuned-triviaqa")
        ...
        start_scores, end_scores = nezha_model(input_ids, attention_mask=attention_mask)
...
class LongformerForTokenClassification(BertPreTrainedModel):
    ...
    Examples::
        ...
        tokenizer = LongformerTokenizer.from_pretrained('allenai/longformer-base-4096')
        nezha_model = LongformerForTokenClassification.from_pretrained('allenai/longformer-base-4096')
        input_ids = torch.tensor(tokenizer.encode("Hello, my dog is cute", add_special_tokens=True)).unsqueeze(0)  # Batch size 1
...
class LongformerForMultipleChoice(BertPreTrainedModel):
    ...
    Examples::
        ...
        tokenizer = LongformerTokenizer.from_pretrained('allenai/longformer-base-4096')
        nezha_model = LongformerForMultipleChoice.from_pretrained('allenai/longformer-base-4096')
