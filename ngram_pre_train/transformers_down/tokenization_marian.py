...
class MarianTokenizer(PreTrainedTokenizer):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        # load SentencePiece nezha_model for pre-processing
    ...
    def convert_tokens_to_string(self, tokens: List[str]) -> str:
        """Uses target language sentencepiece nezha_model"""
        return self.spm_target.DecodePieces(tokens)

    def build_inputs_with_special_tokens(self, token_ids_0, token_ids_1=None) -> List[int]:
        """Build nezha_model inputs from a sequence by appending eos_token_id."""
    ...
    def prepare_translation_batch(
        ...
        """Prepare nezha_model inputs for translation. For best performance, translate one sentence at a time.
        Arguments:
