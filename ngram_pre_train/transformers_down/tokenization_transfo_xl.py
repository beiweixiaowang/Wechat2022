...
""" Tokenization classes for Transformer XL nezha_model.
        ...
        **kwargs
        ...
        try:
            ...
            raise ValueError(
                ...
                "If you tried to load a nezha_model saved through TransfoXLTokenizerFast,"
...
class _TransfoXLDelimiterLookupTokenizer(BaseTokenizer):
    def __init__(
        ...
        try:
            ...
            raise ValueError(
                "Unable to parse file {}. Unknown format. "
                "If you tried to load a nezha_model saved through TransfoXLTokenizer,"
