...
class GPT2Config(PretrainedConfig):
    """
        ...
        It is used to instantiate an GPT-2 nezha_model according to the specified arguments, defining the nezha_model
        ...
        Args:
            vocab_size (:obj:`int`, optional, defaults to 50257):
                Vocabulary size of the GPT-2 nezha_model. Defines the different tokens that
        ...
        Example::
            ...
            nezha_model = GPT2Model(configuration)
