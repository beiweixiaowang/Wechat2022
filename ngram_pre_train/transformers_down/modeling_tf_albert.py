...
class TFAlbertModel(TFAlbertPreTrainedModel):
    ...
    def call(self, inputs, **kwargs):
        ...
        Examples::
            ...
            nezha_model = TFAlbertModel.from_pretrained('albert-base-v2')
...
class TFAlbertForPreTraining(TFAlbertPreTrainedModel):
    ...
    Examples::
        ...
        tokenizer = AlbertTokenizer.from_pretrained('albert-base-v2')
        nezha_model = TFAlbertForPreTraining.from_pretrained('albert-base-v2')
...
class TFAlbertForMaskedLM(TFAlbertPreTrainedModel):
    ...
    Examples::
        ...
        tokenizer = AlbertTokenizer.from_pretrained('albert-base-v2')
        nezha_model = TFAlbertForMaskedLM.from_pretrained('albert-base-v2')
        input_ids = tf.constant(tokenizer.encode("Hello, my dog is cute"))[None, :]  # Batch size 1
        outputs = nezha_model(input_ids)
...
class TFAlbertForSequenceClassification(TFAlbertPreTrainedModel):
    ...
    Examples::
        ...
        tokenizer = AlbertTokenizer.from_pretrained('albert-base-v2')
        nezha_model = TFAlbertForSequenceClassification.from_pretrained('albert-base-v2')
        input_ids = tf.constant(tokenizer.encode("Hello, my dog is cute"))[None, :]  # Batch size 1
        outputs = nezha_model(input_ids)
        logits = outputs[0]
...
class TFAlbertForQuestionAnswering(TFAlbertPreTrainedModel):
    ...
    Examples::
        ...
        tokenizer = AlbertTokenizer.from_pretrained('albert-base-v2')
        nezha_model = TFAlbertForQuestionAnswering.from_pretrained('albert-base-v2')
        input_ids = tokenizer.encode("Who was Jim Henson?", "Jim Henson was a nice puppet")
        start_scores, end_scores = nezha_model(tf.constant(input_ids)[None, :]) # Batch size 1
...
class TFAlbertForMultipleChoice(TFAlbertPreTrainedModel):
    ...
    Examples::
        ...
        tokenizer = AlbertTokenizer.from_pretrained('albert-base-v2')
        nezha_model = TFAlbertForMultipleChoice.from_pretrained('albert-base-v2')
