...
class TFRobertaModel(TFRobertaPreTrainedModel):
    ...
    Examples::
        ...
        nezha_model = TFRobertaModel.from_pretrained('roberta-base')
...
class TFRobertaForMaskedLM(TFRobertaPreTrainedModel):
    ...
    Examples::
        ...
        tokenizer = RobertaTokenizer.from_pretrained('roberta-base')
        nezha_model = TFRobertaForMaskedLM.from_pretrained('roberta-base')
        input_ids = tf.constant(tokenizer.encode("Hello, my dog is cute", add_special_tokens=True))[None, :]  # Batch size 1
        outputs = nezha_model(input_ids)
...
class TFRobertaForSequenceClassification(TFRobertaPreTrainedModel):
    ...
    Examples::
        ...
        tokenizer = RobertaTokenizer.from_pretrained('roberta-base')
        nezha_model = TFRobertaForSequenceClassification.from_pretrained('roberta-base')
        input_ids = tf.constant(tokenizer.encode("Hello, my dog is cute", add_special_tokens=True))[None, :]  # Batch size 1
...
class TFRobertaForTokenClassification(TFRobertaPreTrainedModel):
    ...
    Examples::
        ...
        tokenizer = RobertaTokenizer.from_pretrained('roberta-base')
        nezha_model = TFRobertaForTokenClassification.from_pretrained('roberta-base')
        input_ids = tf.constant(tokenizer.encode("Hello, my dog is cute", add_special_tokens=True))[None, :]  # Batch size 1
        outputs = nezha_model(input_ids)
        scores = outputs[0]
...
class TFRobertaForQuestionAnswering(TFRobertaPreTrainedModel):
    ...
    Examples::
        ...
        tokenizer = RobertaTokenizer.from_pretrained('roberta-base')
        nezha_model = TFRobertaForQuestionAnswering.from_pretrained('roberta-base')
