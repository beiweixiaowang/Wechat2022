...
REFORMER_START_DOCSTRING = r"""
    ...
    Parameters:
        config (:class:`~transformers1.ReformerConfig`): Model configuration class with all the parameters of the nezha_model.
...
REFORMER_INPUTS_DOCSTRING = r"""
    Args:
        input_ids (:obj:`torch.LongTensor` of shape :obj:`(batch_size, sequence_length)`):
            ...
            During training the input_ids sequence_length has to be a multiple of the relevant nezha_model's
...
class ReformerModel(ReformerPreTrainedModel):
    ...
    Examples::
        ...
        nezha_model =  ReformerModel.from_pretrained('google/reformer-crime-and-punishment')
...
class ReformerModelWithLMHead(ReformerPreTrainedModel):
    ...
    Examples::
        ...
        tokenizer = ReformerTokenizer.from_pretrained('google/reformer-crime-and-punishment')
        nezha_model =  ReformerModelWithLMHead.from_pretrained('google/reformer-crime-and-punishment')
