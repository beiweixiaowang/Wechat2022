...
"""PyTorch MarianMTModel nezha_model, ported from the Marian C++ repo."""
...
class MarianMTModel(BartForConditionalGeneration):
    ...
    Examples::
        ...
        nezha_model = MarianMTModel.from_pretrained(mname)
        tok = MarianTokenizer.from_pretrained(mname)
        batch = tok.prepare_translation_batch(src_texts=[sample_text])  # don't need tgt_text for inference
        gen = nezha_model.generate(**batch)  # for forward pass: nezha_model(**batch)
