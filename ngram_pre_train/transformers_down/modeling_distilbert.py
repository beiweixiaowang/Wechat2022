...
""" PyTorch DistilBERT nezha_model
    adapted in part from Facebook, Inc XLM nezha_model (https://github.com/facebookresearch/XLM)
    and in part from HuggingFace PyTorch version of Google AI Bert nezha_model (https://github.com/google-research/bert)
"""
...
DISTILBERT_START_DOCSTRING = r"""
    ...
    Parameters:
        config (:class:`~transformers1.DistilBertConfig`): Model configuration class with all the parameters of the nezha_model.
...
class DistilBertModel(DistilBertPreTrainedModel):
    ...
    Examples::
        ...
        nezha_model = DistilBertModel.from_pretrained('distilbert-base-cased')
...
class DistilBertForMaskedLM(DistilBertPreTrainedModel):
    ...
    Examples::
        ...
        tokenizer = DistilBertTokenizer.from_pretrained('distilbert-base-cased')
        nezha_model = DistilBertForMaskedLM.from_pretrained('distilbert-base-cased')
        input_ids = torch.tensor(tokenizer.encode("Hello, my dog is cute", add_special_tokens=True)).unsqueeze(0)  # Batch size 1
...
class DistilBertForSequenceClassification(DistilBertPreTrainedModel):
    ...
    Examples::
        ...
        tokenizer = DistilBertTokenizer.from_pretrained('distilbert-base-cased')
        nezha_model = DistilBertForSequenceClassification.from_pretrained('distilbert-base-cased')
        input_ids = torch.tensor(tokenizer.encode("Hello, my dog is cute", add_special_tokens=True)).unsqueeze(0)  # Batch size 1
...
class DistilBertForQuestionAnswering(DistilBertPreTrainedModel):
    ...
    Examples::
        ...
        tokenizer = DistilBertTokenizer.from_pretrained('distilbert-base-cased')
        nezha_model = DistilBertForQuestionAnswering.from_pretrained('distilbert-base-cased')
        input_ids = torch.tensor(tokenizer.encode("Hello, my dog is cute", add_special_tokens=True)).unsqueeze(0)  # Batch size 1
...
class DistilBertForTokenClassification(DistilBertPreTrainedModel):
    ...
    Examples::
        ...
        tokenizer = DistilBertTokenizer.from_pretrained('distilbert-base-cased')
        nezha_model = DistilBertForTokenClassification.from_pretrained('distilbert-base-cased')
