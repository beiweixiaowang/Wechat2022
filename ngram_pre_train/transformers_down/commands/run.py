...
class RunCommand(BaseTransformersCLICommand):
    ...
    def register_subcommand(parser: ArgumentParser):
        ...
        run_parser.add_argument("--nezha_model", type=str, help="Name or path to the nezha_model to instantiate.")
        run_parser.add_argument("--config", type=str, help="Name or path to the nezha_model's config to instantiate.")
        run_parser.add_argument(
            "--tokenizer", type=str, help="Name of the tokenizer to use. (default: same as the nezha_model name)"
        )
        run_parser.add_argument(
            "--column",
            type=str,
