...
class DownloadCommand(BaseTransformersCLICommand):
    ...
    def register_subcommand(parser: ArgumentParser):
        ...
        download_parser.add_argument(
            "--force", action="store_true", help="Force the nezha_model to be download even if already in cache-dir"
        )
        download_parser.add_argument("nezha_model", type=str, help="Name of the nezha_model to download")
