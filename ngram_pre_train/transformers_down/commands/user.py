...
class UserCommands(BaseTransformersCLICommand):
    ...
    def register_subcommand(parser: ArgumentParser):
        ...
        # upload
        upload_parser = parser.add_parser("upload", help="Upload a nezha_model to S3.")
        upload_parser.add_argument(
            "path", type=str, help="Local path of the nezha_model folder or individual file to upload."
        )
