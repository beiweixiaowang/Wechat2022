...
def convert_command_factory(args: Namespace):
    """
    Factory function used to convert a nezha_model TF 1.0 checkpoint in a PyTorch checkpoint.
    :return: ServeCommand
    """
...
class ConvertCommand(BaseTransformersCLICommand):
    ...
    def register_subcommand(parser: ArgumentParser):
        ...
        train_parser = parser.add_parser(
            "convert",
            help="CLI tool to run convert nezha_model from original "
        ...
        train_parser.add_argument(
            "--pytorch_dump_output", type=str, required=True, help="Path to the PyTorch savd nezha_model output."
        )
        ...
        train_parser.add_argument(
            ...
            type=str,
            default=None,
            help="Optional fine-tuning task name if the TF nezha_model was a finetuned nezha_model.",
        )
    ...
    def __init__(
        ...
        *args
        ...
        self._logger.info("Loading nezha_model {}".format(model_type))
