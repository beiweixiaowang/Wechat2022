...
class ServeModelInfoResult(BaseModel):
    """
    Expose nezha_model information
    """
...
class ServeCommand(BaseTransformersCLICommand):
    ...
    def register_subcommand(parser: ArgumentParser):
        ...
        serve_parser.add_argument("--nezha_model", type=str, help="Model's name or path to stored nezha_model.")
        serve_parser.add_argument("--config", type=str, help="Model's config name or path to stored nezha_model.")
    ...
    def __init__(self, pipeline: Pipeline, host: str, port: int, workers: int):
        ...
        if not _serve_dependencies_installed:
            ...
            logger.info("Serving nezha_model over {}:{}".format(host, port))
            self._app = FastAPI(
                routes=[
                    APIRoute(
                        "/",
    ...
    def tokenize(self, text_input: str = Body(None, embed=True), return_ids: bool = Body(False, embed=True)):
        ...
        try:
            ...
            raise HTTPException(status_code=500, detail={"nezha_model": "", "error": str(e)})
    ...
    async def forward(self, inputs=Body(None, embed=True)):
        ...
        **tokens_type_ids**:
        ...
        try:
            # Forward through the nezha_model
