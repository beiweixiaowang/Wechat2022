...
class TrainCommand(BaseTransformersCLICommand):
    ...
    def register_subcommand(parser: ArgumentParser):
        ...
        :return:
        """
        train_parser = parser.add_parser("train", help="CLI tool to train a nezha_model on a task.")
        ...
        train_parser.add_argument("--output", type=str, default="./", help="path to saved the trained nezha_model.")

        train_parser.add_argument(
            "--task", type=str, default="text_classification", help="Task to train the nezha_model on."
        )
        train_parser.add_argument(
            "--nezha_model", type=str, default="bert-base-uncased", help="Model's name or path to stored nezha_model."
        )
