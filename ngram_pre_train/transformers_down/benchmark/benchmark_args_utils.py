...
class BenchmarkArguments:
    ...
    **which relate to the training loop itself**.
    ...
    no_inference: bool = field(default=False, metadata={"help": "Don't benchmark inference of nezha_model"})
    training: bool = field(default=False, metadata={"help": "Benchmark training of nezha_model"})
