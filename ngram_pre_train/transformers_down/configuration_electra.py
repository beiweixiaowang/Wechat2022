...
""" ELECTRA nezha_model configuration """
...
class ElectraConfig(PretrainedConfig):
    r"""
        ...
        It is used to instantiate an ELECTRA nezha_model according to the specified arguments, defining the nezha_model
        ...
        Args:
            vocab_size (:obj:`int`, optional, defaults to 30522):
                Vocabulary size of the ELECTRA nezha_model. Defines the different tokens that
        ...
        Example::
            ...
            # Initializing a nezha_model from the electra-base-uncased style configuration
            nezha_model = ElectraModel(configuration)
