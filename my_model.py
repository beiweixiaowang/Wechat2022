...
class MultiModal(nn.Module):
    def __init__(self, args):
        ...
        self.bert_fusion = TextConcatDenseSE(text_input_size=bert_output_size*2 + tfidf_output_size,
    ...
    def forward(self, inputs, inference=False):
        ...
        # 将bert和tfidf合并进行embedding
        text_embedding = self.bert_fusion([bert_embedding_1, bert_embedding_2, inputs['tfidf']])
