...
def parse_args():
    ...
    # ========================= Data Configs ==========================
    parser.add_argument('--train_annotation', type=str, default='./temp_data/new_train_text.pkl')
    parser.add_argument('--test_annotation', type=str, default='./temp_data/new_test_text.pkl')
    ...
    parser.add_argument('--test_output_csv', type=str, default='data/result_ema_fgm.csv')
    ...
    # ======================== SavedModel Configs =========================
    parser.add_argument('--savedmodel_path', type=str, default='save/my_model')

    parser.add_argument('--ckpt_file', type=str, default='save/v3/model_epoch_3_mean_f1_0.6527.bin')
    parser.add_argument('--best_score', default=0.5, type=float, help='save checkpoint if mean_f1 > best_score')

    # ========================= Learning Configs ==========================
    parser.add_argument('--max_epochs', type=int, default=15, help='How many epochs')
